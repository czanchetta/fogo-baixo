...
RECEITAS.push(
...

  {
    ...
    notas: [
      ...
      T("Conservação: vidro tampado na geladeira, e consuma de preferência em até 4 ou 5 dias — é alho cru batido com óleo, sem acidez nem pH medidos, então não é candidato a prazo longo. Separação é normal, chacoalhe antes de servir. Sirva sempre com colher limpa, sem devolver o que sobrou no prato.",
        "Conservación: frasco tapado en la nevera, y consumí de preferencia dentro de 4 o 5 días — es ajo crudo licuado con aceite, sin acidez ni pH medidos, así que no es candidato a un plazo largo. La separación es normal, agitá antes de servir. Serví siempre con cuchara limpia, sin devolver lo que sobró en el plato.",
        "Keeping: covered glass jar in the fridge, and preferably eaten within 4 to 5 days — it is raw garlic blended with oil, with no measured acidity or pH, so it is not a candidate for long storage. Separation is normal, shake before serving. Always serve with a clean spoon, and never return what was left on a plate."),
